...
In  sum,  the  forward  loop  prepares  the  organism  to  anticipate  and  respond  optimally  to  a  threat, while the feedback loop ensures returning efficiently to a homeostatic balance when it is no longer challenged (for review see de Kloet et al., 1998).It has been shown that the negative feedback control of the HPA axis can become dys-regulated,  particularly  following  periods  of  chronic  stress.  (Jubb, 2016). 
